...
import com.example.efhem_rouhek.DAO.CategorieDAO;
...
@Database(entities = {symptomes.class, maladie.class, doctor.class, categorie.class}, version = 1, exportSchema = false)
